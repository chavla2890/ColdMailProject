...
const scheduleEmails = async () => {
  ...
  for (const node of sequence.nodes) {
    ...
    if (node.data.label.startsWith("Cold-Email")) {
      ...
      totalDelay += 5000;
      console.log(`Scheduling email to: ${to}, Subject: ${subject}, Delay: ${totalDelay}ms`);
